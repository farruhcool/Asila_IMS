...
class SupplierCreateView(SuccessMessageMixin, CreateView):
    ...
    success_message = "Yetkazib beruvchi muvofaqiyatli kiritildi"
    template_name = "suppliers/edit_supplier.html"

    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context["title"] = 'Yangi yetkazib beruvchi'
        context["savebtn"] = 'Yetkazib beruvchi qo\'shish'
        return context
...
class SupplierUpdateView(SuccessMessageMixin, UpdateView):
    ...
    form_class = SupplierForm
    success_url = '/transaction/suppliers'
    success_message = "Yetkazib beruvchi muvofaqiyatli yangilandi"
    template_name = "suppliers/edit_supplier.html"

    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context["title"] = 'Tahrirlash'
        context["savebtn"] = 'Saqlash'
        context["delbtn"] = 'O\'chirish'
        return context
...
class SupplierDeleteView(View):
    ...
    success_message = "Yetkazib beruvchi muvofaqiyatli o'chirildi"
    ...
    def post(self, request, pk):
        ...
        if formset.is_valid():
            ...
            for form in formset:  # for loop to save each individual form as its own object
                ...
                stock.save()
                billitem.save()
            messages.success(request, "Kirim maxsulotlar muvofaqiyatli kiritildi")
    ...
    def delete(self, *args, **kwargs):
        ...
        for item in items:
            ...
            if stock.is_deleted == False:
                ...
                stock.save()
        messages.success(self.request, "Kirim cheki muvofaqiyatli o'chirildi")
